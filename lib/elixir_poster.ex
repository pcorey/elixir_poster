defmodule ElixirPoster do
  ...
  def get_pixel_reducer(code, width, ratio, y) do
    fn ({pixel, x}, pixels) ->
      ...
      merge_pixel_into_row(color, character, x * ratio, y, pixels)
    end
  end
  ...
  # def go, do: go(1228/2014, 6000, 9000, "./full_code", "./admithub.png", "out.svg")
  # def go, do: go(1228/2014, 5400, 7200, "./full_code", "./admithub.png", "out.svg")
  def go, do: go(1228/2014, 3150, 4050, "./full_code", "./admithub.png", "out.svg")
